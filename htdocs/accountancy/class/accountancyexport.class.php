...
class AccountancyExport
{
	...
	public static $EXPORT_TYPE_QUADRATIERS = 11;
	...
	public static function getType() {
		...
		return array (
				...
				self::$EXPORT_TYPE_QUADRATIERS => $langs->trans('Modelcsv_QUADRATIERS'),
			);
	}
	...
	public static function getTypeConfig() {
		...
		return array (
			'param' => array(
				...
				self::$EXPORT_TYPE_QUADRATIERS => array(
					'label' => $langs->trans('Modelcsv_quadratiers'),
					'ACCOUNTING_EXPORT_FORMAT' => 'txt',
				),
			),
			'cr'=> array (
	...
	public function export(&$TData) {
		...
		switch ($conf->global->ACCOUNTING_EXPORT_MODELCSV) {
			...
			case self::$EXPORT_TYPE_CONFIGURABLE :
				...
				break;
			case self::$EXPORT_TYPE_QUADRATIERS :
				$this->exportQuadratiers($TData);
				break;
			default:
...
public function exportQuadratiers(&$TData) {
		global $conf;
